...
data = {"nGroup": 1, "pHostNames":[host_id]}
response = session.post(url=url, headers=common_headers, data=json.dumps(data), verify=False)
print("Host removed from Isolation. You can find the device in Unassigned group. Please move it appropriate group.")
...
subject = "Host removed from Isolation"
...
<html>
  ...
  <body>
    <p>Dear Team,<br>
      <br>
      Below host removed from Isolation.
      <br><br>
       <p> """+hostname+"""
    </table>
    </p>
